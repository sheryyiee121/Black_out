    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div data-animate="fade-up" className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-2 text-xs font-medium uppercase tracking-widest text-[#171717]">
            Prestige in Motion
          </p>
        ...
        {/* Middle: Get in Touch + Follow Us (rounded grey container) */}
        <div
          data-animate="icon-stagger"
          className="mt-12 rounded-2xl px-6 py-8 sm:px-10 sm:py-10"
        ...
        {/* Copyright */}
        <div
          className="mt-14 pt-8 border-t text-center text-sm text-[#737373]"
          style={{ borderColor: "rgba(227, 227, 227, 0.6)" }}
        >
